...
function dePalabrasAFrase(palabras) {
  ...
  const miArray = ['Hello', 'world!'];
  const frase = dePalabrasAFrase(miArray);
...
function empiezaConNueve(num) {
  ...
  // Tu código:
  let numComoCadena = num.toString();
  if (numComoCadena.charAt(0) === '9') {
    return true;
  } else {
    return false;
  }
...
function mayorACien(array) {
  ...
  // Tu código:
  var mayoresACien = array.filter(function (num) {
    return num > 100;
  });
  return mayoresACien;
}
